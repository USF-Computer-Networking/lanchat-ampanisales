	...
	while True:
		try:
			if args.s is not False:
				decision = args.s.lower()
			elif args.c is not False:
				decision = args.c.lower()
			else:
...
parser.add_argument('-s', action=store_true, default=False, const ="s", help="Starts LAN Scanner")
parser.add_argument('-c', action=store_true, default=False, const ="c", help="Starts UDP Chat")
